...
func input(templete: inout EFTemplete) {
    ...
    templete.description.set("普通的 iOS 开发 懂些前端和后端")
    ...
    templete.project.set(
        [
            ...
            [
                "category": "上海xxx信息科技有限公司（2016.05 — 2016.12）",
            ...
            [
                "category": "无锡xx科技有限公司（2015.03 — 2016.05）",
            ...
            [
                "category": "无锡xxx科技有限公司（2014.09 — 2015.01）",
